			...
			<div class="twelve columns">
				<div class="box_c">
					...
					<div class="box_c_content">
						<form action="<?php echo base_url()?>index.php/feedback/teacher_feedback/feedback_by_student" id="frm_teacher_feedback" enctype="multipart/form-data"  class="nice" method="post" onsubmit="return validate_student_registration();">
							...
							<div class="formRow">
								...
								<div class="row">
									...
									<div class="three columns">
										...
										<label for="ans_op3">Excellent</label>
									</div>
									<div class="four columns">
										<input type="radio" name="ans1" id="ans_op4" value="4">
										<label for="ans_op4">Very Excellent</label>
									</div>									
							...
							<div class="formRow">
								...
								<div class="row">
									...
									<div class="three columns">
										...
										<label for="ans_op7">Excellent</label>
									</div>
									<div class="four columns">
										<input type="radio" name="ans2" id="ans_op8" value="4">
										<label for="ans_op8">Very Excellent</label>
									</div>									
							...
							<div class="formRow">
								...
								<div class="row">
									...
									<div class="three columns">
										...
										<label for="ans_op11">Excellent</label>
									</div>
									<div class="four columns">
										<input type="radio" name="ans3" id="ans_op12" value="4">
										<label for="ans_op12">Very Excellent</label>
									</div>									
							...
							<div class="formRow">
								...
								<div class="row">
									...
									<div class="three columns">
										...
										<label for="ans_op15">Excellent</label>
									</div>
									<div class="four columns">
										<input type="radio" name="ans4" id="ans_op16" value="4">
										<label for="ans_op16">Very Excellent</label>
									</div>									
							...
							<div class="formRow">
								...
								<div class="row">
									...
									<div class="three columns">
										...
										<label for="ans_op19">Excellent</label>
									</div>
									<div class="four columns">
										<input type="radio" name="ans5" id="ans_op20" value="4">
										<label for="ans_op20">Very Excellent</label>
									</div>									
							...
							<div class="formRow">
								...
								<div class="row">
									...
									<div class="three columns">
										...
										<label for="ans_op23">Excellent</label>
									</div>
									<div class="four columns">
										<input type="radio" name="ans6" id="ans_op24" value="4">
										<label for="ans_op24">Very Excellent</label>
									</div>									
							...
							<div class="formRow">
								...
								<div class="row">
									...
									<div class="three columns">
										...
										<label for="ans_op27">Excellent</label>
									</div>
									<div class="four columns">
										<input type="radio" name="ans7" id="ans_op28" value="4">
										<label for="ans_op28">Very Excellent</label>
									</div>									
							...
							<div class="formRow">
								...
								<div class="row">
									...
									<div class="three columns">
										...
										<label for="ans_op31">Excellent</label>
									</div>
									<div class="four columns">
										<input type="radio" name="ans8" id="ans_op32" value="4">
										<label for="ans_op32">Very Excellent</label>
									</div>									
							...
							<div class="formRow">
								...
								<div class="row">
									...
									<div class="three columns">
										...
										<label for="ans_op35">Excellent</label>
									</div>
									<div class="four columns">
										<input type="radio" name="ans9" id="ans_op36" value="4">
										<label for="ans_op36">Very Excellent</label>
									</div>									
							...
							<div class="formRow">
								...
								<div class="row">
									...
									<div class="three columns">
										...
										<label for="ans_op39">Excellent</label>
									</div>
									<div class="four columns">
										<input type="radio" name="ans10" id="ans_op40" value="4">
										<label for="ans_op40">Very Excellent</label>
									</div>									
