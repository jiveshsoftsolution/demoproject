        ...
        <div class="twelve columns">
			<div class="box_c">
				...
				<div class="box_c_content">
					<form action="<?php echo base_url()?>index.php/feedback/feedback/edit_feedback" id="frm_add_feedback" class="nice" method="post" onsubmit="return validate_add_feedback();">
					   <h3>Edit Feedback</h3>             
						<div class="formRow">
							<div class="row">
								<div class="twelve columns">
									<label for="feedback_subject">Subject</label>
									<input id="feedback_subject" name="feedback_subject" class="input-text large"  placeholder="Subject" value="<?php echo $edit_feedback->feedback_subject?>">
									<input id="feedback_id" name="feedback_id" value="<?php echo $edit_feedback->feedback_id?>" type="hidden">
						...
						<div class="formRow">
							<div class="row">
								<div class="twelve columns">
									...
									<textarea id="feedback_description" name="feedback_description" class="input-text large"  placeholder="Description" style="width:100%;height:250px"><?php echo $edit_feedback->feedback_description?></textarea>
