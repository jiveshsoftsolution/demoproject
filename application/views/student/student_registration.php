		...
		<div class="twelve columns">
		  <div class="box_c">
			...
			<div class="formRow">
						<div class="row">
							...
							<div  class="four columns">
								...
								<input type="text" id="card_no" name="card_no" class="input-text small" placeholder="Card No" />
			...
			<div class="formRow">
						<div class="row">
							<div class="three columns">
							  <label for="class_section_id">Select Class Section <span class="sp_required">*</span></label>
							...
							<div class="three columns">
							  <label for="session_id">Select Session <span class="sp_required">*</span></label>
			...
			<div class="formRow">
						<div class="row">
							...
							<div class="four columns">
								<label for="parent_mobile">Mobile No. <span class="sp_required">*</span> </label><label style="font-family: tahoma !important; font-size: 11px;">(10 Digits only)</label>
			...
			<div class="formRow">
						<div class="row">
							<div  class="three columns">
								...
								<input type="text" id="pincode" name="pincode" class="input-text large" placeholder="Pincode" maxlength="6" />
			  ...
			  <div class="row">
						<div class="three columns">
							<label for="father_salutation_id">Salutation</label>
							<select class="small" name="father_salutation_id" id="father_salutation_id">
								<?php foreach($salutation as $salutationData) {?>
									<option value="<?php echo $salutationData->salutation_id?>" <?php if($salutationData->salutation_id==1) echo "selected='selected'" ?>><?php echo $salutationData->salutation?></option>
								<?php }?>
							</select>
							<span id="sp_father_salutation_id" class="error">Select Salutation.</span>
						</div>
			    <div class="three columns">
						  <label for="father_first_name">Father First Name <span class="sp_required">*</span></label>
			    ...
			    <div class="four columns">
						  <label for="father_last_name">Father Last Name <span class="sp_required">*</span></label>
					  ...
					  <div class="row">
						<div class="three columns">
							...
							<select class="small" name="mother_salutation_id" id="mother_salutation_id">
								<?php foreach($salutation as $salutationData) {?>
									<option value="<?php echo $salutationData->salutation_id?>" <?php if($salutationData->salutation_id==2) echo "selected='selected'" ?>><?php echo $salutationData->salutation?></option>
								<?php }?>
							</select>
