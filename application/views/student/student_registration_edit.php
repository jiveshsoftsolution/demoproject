				    ...
				    <h3>Personal Information</h3>
						...
						<div class="formRow">
							<div class="row">
								...
								<div  class="four columns">
									...
									<input type="text" id="card_no" name="card_no" class="input-text small" placeholder="Card No" value="<?php echo $studentRecord->card_no ?>" />
						...
						<div class="formRow">
							<div class="row">
								...
								<div class="four columns">
									<label for="parent_mobile">Mobile No.</label><label style="font-family: tahoma !important; font-size: 11px;">(10 Digits only)</label>
